...
public class FoodCartTest {
	...
	/*
	 * @Test public void addFoodCartTest() {
	 * 
	 ...
	 * restro.add(r1);
	 * 
	 * List<Items> items = new ArrayList<>(); Items item = new Items(114, "item6",
	 * cat, 2, 100, restro); items.add(item);
	 * 
	 ...
	 * when(foodCartService.addItemToCart(cart)).thenReturn(cart); FoodCart cart1 =
	 * foodCartService.addItemToCart(cart); assertEquals(cart, cart1); }
	 * 
	 * @Test public void viewCartTest() { Address hoteladdress = new Address(101,
	 ...
	 * "9011872311", custaddress, "tmidgule98@gmail.com");
	 * 
	 * FoodCart cart = new FoodCart(12, cust, items); FoodCartServiceInterface
	 * foodCartService = mock(FoodCartServiceImpl.class);
	 * when(foodCartService.findCart(12)).thenReturn(cart); FoodCart cart1 =
	 * foodCartService.findCart(12); assertEquals(cart,cart1);
	 * 
	 * }
	 * 
	 * @Test public void removeCart() { Address hoteladdress = new Address(101,
	 * "Pride", "S10Road", "Shivajinagar", "Pune", "Maharashtra", "India", 412217);
	 * 
	 * Address custaddress = new Address(102, "Shashikant", "Lane2", "Swargate",
	 * "Pune", "Maharashtra", "India", 412201);
	 ...
	 * 
	 * when(foodCartService.clearCart(12)).thenReturn(Boolean.TRUE); Boolean
	 * cartService2=foodCartService.clearCart(12); assertEquals(Boolean.TRUE,
	 * cartService2); }
	 */
}
